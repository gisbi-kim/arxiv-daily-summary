...
## [출력 형식 — HTML 단일 파일]
- 파일명: `YYYY-MM-DD.html` (스케줄 실행일 기준)
- inline CSS로 self-contained, 브라우저 더블클릭 시 바로 렌더링
- 스타일 기준 파일: https://raw.githubusercontent.com/gisbi-kim/arxiv-daily-summary/main/2026-04-18.html
...
4. HTML 파일을 repo 루트에 `YYYY-MM-DD.html` 로 저장
...
🔗 <https://gisbi-kim.github.io/arxiv-daily-summary/YYYY-MM-DD.html|전체 리포트 보기>
📊 *주간 한 줄 요약*
